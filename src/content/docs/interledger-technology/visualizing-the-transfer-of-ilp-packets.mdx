...
The third kind of packet is a **Reject** packet, which does what you expect. If any problems occur at any stage in the process, this packet is sent back, cancelling the transaction.

This whole process happens in milliseconds, and in fact if it doesn’t happen quickly enough, that will itself trigger a Reject packet.
